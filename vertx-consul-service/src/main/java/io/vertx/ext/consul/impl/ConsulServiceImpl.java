...
public class ConsulServiceImpl implements ConsulService {
  ...
  @Override
  public ConsulService healthState(HealthState healthState, Handler<AsyncResult<CheckList>> resultHandler) {
    consulClient.healthState(healthState, resultHandler);
    return this;
  }

  @Override
  public ConsulService healthStateWithOptions(HealthState healthState, CheckQueryOptions options, Handler<AsyncResult<CheckList>> resultHandler) {
    consulClient.healthStateWithOptions(healthState, options, resultHandler);
    return this;
  }
